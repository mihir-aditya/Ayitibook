...
.custom-price .cents {
  ...
  position: absolute;
  top: 0;
  right: -20px; /* Adjust this value based on spacing */
  line-height: 1;
}

.meta-div {
  gap: 20px;              /* Space between price and strike price */
}
...
.announce-nav:hover { background: rgba(0,0,0,0.18); }

@media (max-width: 900px) {
  .announce-nav { display: none; }
  .announce-item { min-width: 200px; max-width: 100%; text-align: center; }
  .announce-sep { display: none; }
  .announcement-wrap { padding: 12px; border-radius: 20px; }
  .announce-slide { flex-direction: column; gap: 8px; }
  .announce-item i { font-size: 30px; }
  .announce-text p { font-size: 13px; }
}
      ...
      <section class="announcement-bar my-3" role="region" aria-label="Payment and delivery information">
        <div class="announcement-wrap container">
          <div class="announce-slide" tabindex="0">
            ...
            <div class="announce-item">
              <img src="./assets/images/footer/icon-delivery.png" alt="icon-delivery" class="announce-icon">
              <div class="announce-text">
                <h6>GUARANTEED DELIVERY</h6>
                <p>We ensure predictable, safe, and on-time delivery, supported by certified agents and shipping insurance.</p>
              </div>
            </div>
            ...
            <div class="announce-item">
              ...
              <div class="announce-text">
                ...
                <p>Enjoy your purchase for up to 30 days. Returns are simple — if you’re not happy, your money comes right back.</p>
              </div>
            </div>
            ...
            <div class="announce-item">
              ...
              <div class="announce-text">
                ...
                <p>From quick chatbot responses to dedicated human care, we’re here 24/7 to keep your experience smooth, simple, and worry-free.</p>
              </div>
            </div>
            ...
            <div class="swiper-wrapper">
                  ...
                  <div class="content-box">
                    ...
                    <div class="meta-div">
                      <div class="custom-price">
                        ...
                        <span class="main">120</span>
                        <span class="cents">99</span> 
                      </div>
                      <p class="text1 text-muted mb-0 "><strike>$160</strike></p>
              ...
              <div class="swiper-slide">
                <div class="latest-sale-box mb-4">
                  ...
                  <div class="content-box">
                    <h6 class="title">
                      <a href="product-detail.php"> AK-900 Wired Keyboard</a>
                    </h6>
                    <div class="meta-div">
                      <div class="custom-price">
                        <span class="currency">$</span>
                        <span class="main">900</span>
                        <span class="cents">68</span> 
                      </div>
                ...
                <div class="latest-sale-box mb-4">
                  ...
                  <div class="content-box">
                    ...
                    <div class="meta-div">
                      <div class="custom-price">
                        <span class="currency">$</span>
                        <span class="main">370</span>
                        <span class="cents">14</span> 
                      </div>
              ...
              <div class="swiper-slide">
                <div class="latest-sale-box mb-4">
                  ...
                  <div class="content-box">
                    <h6 class="title">
                      <a href="product-detail.php">S-Series Comfort Chair</a>
                    </h6>
                    <div class="meta-div">
                      <div class="custom-price">
                        <span class="currency">$</span>
                        <span class="main">4999</span>
                        <span class="cents">06</span> 
                      </div>
                      <p class="text1 text-muted "><strike>$400</strike></p>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="latest-sale-box mb-4">
                  ...
                  <div class="content-box">
                    <h6 class="title"><a href="product-detail.php">HAVIT HV-G92 Gamepad</a>
                    </h6>
                    <div class="meta-div">
                      <span class="text1 text-danger">$120</span>
                      <p class="text1 text-secondary ">$160</p>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="latest-sale-box mb-4">
                  ...
                  <div class="content-box">
                    <h6 class="title">
                      <a href="product-detail.php"> Breed Dry Dog Food</a>
                    </h6>
                    <div class="meta-div">
              ...
              <div class="swiper-slide">
                <div class="latest-sale-box mb-4">
                  ...
                  <div class="content-box">
                    <h6 class="title">
                      <a href="product-detail.php"> CANON EOS DSLR Camera</a>
                    </h6>
                    <div class="meta-div">
              ...
              <div class="swiper-slide">
                <div class="latest-sale-box mb-4">
                  ...
                  <div class="content-box">
                    <h6 class="title">
                      <a href="product-detail.php"> Curology Product Set</a>
                    </h6>
                    <div class="meta-div">
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="latest-sale-box mb-4">
                  ...
                  <div class="content-box">
                    ...
                    <h6 class="title">
                      <a href="product-detail.php"> Kids Electric Car</a>
                    </h6>
                    <div class="meta-div">
                      <span class="text1 text-danger">$960</span>
                    </div>
              ...
              <div class="swiper-slide">
                <div class="latest-sale-box mb-4">
                  ...
                  <div class="content-box">
                    <h6 class="title">
                      <a href="product-detail.php"> Jr. Zoom Soccer Cleats</a>
                    </h6>
                    <div class="meta-div">
              ...
              <div class="swiper-slide">
                <div class="latest-sale-box mb-4">
                  ...
                  <div class="content-box">
                    ...
                    <h6 class="title">
                      <a href="product-detail.php"> GP11 Shooter USB Gamepad</a>
                    </h6>
                    <div class="meta-div">
              ...
              <div class="swiper-slide">
                <div class="latest-sale-box mb-4">
                  ...
                  <div class="content-box">
                    <h6 class="title">
                      <a href="product-detail.php">Quilted Satin Jacket</a>
                    </h6>
                    <div class="meta-div">
                      <span class="text1 text-danger">$660</span>
