...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <head>
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{ asset('seller/vendors/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
    <link href="{{ asset('seller/vendors/dropzone/dropzone.css') }}" rel="stylesheet">
    <link href="{{ asset('seller/vendors/glightbox/glightbox.min.css') }}" rel="stylesheet">
  ...
  <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-0">
              <div class="row gx-0 gy-2 w-100 flex-between-center">
                <div class="col-auto"><a class="text-decoration-none" href="../../../index.html">
                    <div class="d-flex align-items-center"><img src="{{ asset('seller/assets/img/icons/logo.png') }}" alt="phoenix" width="27">
                ...
                <div class="col-auto order-md-1">
                  <ul class="navbar-nav navbar-nav-icons flex-row me-n2">
                    ...
                    <li class="nav-item"><a class="nav-link px-2 icon-indicator icon-indicator-primary" href="cart.html" role="button"><span class="text-body-tertiary" data-feather="shopping-cart" style="height:20px;width:20px;"></span><span class="icon-indicator-number">3</span></a></li>
                            ...
                            <div class="scrollbar-overlay" style="height: 27rem;">
                              <div class="px-2 px-sm-3 py-3 notification-card position-relative read border-bottom">
                                <div class="d-flex align-items-center justify-content-between position-relative">
                                  <div class="d-flex">
                                    <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="{{ asset('seller/assets/img/team/40x40/30.webp') }}" alt=""></div>
                              ...
                              <div class="px-2 px-sm-3 py-3 notification-card position-relative unread border-bottom">
                                <div class="d-flex align-items-center justify-content-between position-relative">
                                  <div class="d-flex">
                                    <div class="avatar avatar-m status-online me-3"><img class="rounded-circle avatar-placeholder" src="{{ asset('seller/assets/img/team/40x40/avatar.webp') }}" alt=""></div>
                                    <div class="flex-1 me-sm-3">
                                      <h4 class="fs-9 text-body-emphasis">Jessie Samson</h4>
                              ...
                              <div class="px-2 px-sm-3 py-3 notification-card position-relative unread border-bottom">
                                <div class="d-flex align-items-center justify-content-between position-relative">
                                  <div class="d-flex">
                                    <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="{{ asset('seller/assets/img/team/40x40/57.webp') }}" alt=""></div>
                                    <div class="flex-1 me-sm-3">
                              ...
                              <div class="px-2 px-sm-3 py-3 notification-card position-relative unread border-bottom">
                                <div class="d-flex align-items-center justify-content-between position-relative">
                                  <div class="d-flex">
                                    <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="{{ asset('seller/assets/img/team/40x40/59.webp') }}" alt=""></div>
                                    <div class="flex-1 me-sm-3">
                              ...
                              <div class="px-2 px-sm-3 py-3 notification-card position-relative read ">
                                <div class="d-flex align-items-center justify-content-between position-relative">
                                  <div class="d-flex">
                                    <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="{{ asset('seller/assets/img/team/40x40/58.webp') }}" alt=""></div>
                                    <div class="flex-1 me-sm-3">
                          ...
                          <div class="card-body p-0">
                            <div class="text-center pt-4 pb-3">
                              <div class="avatar avatar-xl ">
                                <img class="rounded-circle " src="{{ asset('seller/assets/img/team/72x72/57.webp') }}" alt="">
                              </div>
              ...
              <div class="col-12 col-lg-6">
                <div class="d-flex flex-column justify-content-between h-100">
                  <div>
                    ...
                    <div class="d-flex flex-wrap align-items-start mb-3"><span class="badge text-bg-success fs-9 rounded-pill me-2 fw-semibold">#1 Best seller</span><a class="fw-semibold" href="#!">in Adminzone sell analytics 2021</a></div>
                    <div class="d-flex flex-wrap align-items-center">
                      @if ($product->currency == 'USD')
                        <p class="fs-3 fw-bold mb-0 me-3 text-body-emphasis">${{ number_format($product->price, 2) }}</p>
                      @elseif ($product->currency == 'EUR')
                        <p class="fs-3 fw-bold mb-0 me-3 text-body-emphasis">€{{ number_format($product->price, 2) }}</p>
                      @elseif ($product->currency == 'GBP')
                        <p class="fs-3 fw-bold mb-0 me-3 text-body-emphasis">£{{ number_format($product->price, 2) }}</p>
                      @elseif ($product->currency == 'INR')
                        <p class="fs-3 fw-bold mb-0 me-3 text-body-emphasis">₹{{ number_format($product->price, 2) }}</p>
                      ...
                      @if ($product->discount_price >0)
                        @if ($product->currency == 'USD')
                          <p class="fs-5 text-decoration-line-through text-body-tertiary mb-0"> ${{ number_format($product->discount_price, 2) }}</p>
                        @elseif ($product->currency == 'EUR')
                          <p class="fs-5 text-decoration-line-through text-body-tertiary mb-0"> €{{ number_format($product->discount_price, 2) }}</p>
                        @elseif ($product->currency == 'GBP')
                          <p class="fs-5 text-decoration-line-through text-body-tertiary mb-0"> £{{ number_format($product->discount_price, 2) }}</p>
                    ...
                    @if ($product->stock_quantity >= $product->low_stock_quantity )
                      
                      <p class="text-success fw-bold mb-4">In Stock</p>
                    
                    @else
                    
                      <p class="text-danger fw-bold mb-4">Out of Stock</p>
                  ...
                  <div>
                    <div class="mb-3">
                      ...
                      <div class="d-flex product-color-variants" data-product-color-variants="data-product-color-variants">
                        <div class="rounded-1 border border-translucent me-2 active" data-variant="Blue" data-products-images='["{{ asset('seller/assets/img/products/details/blue_front.png') }}","{{ asset('seller/assets/img/products/details/blue_back.png') }}","{{ asset('seller/assets/img/products/details/blue_side.png') }}"]'><img src="{{ asset('seller/assets/img/products/details/blue_front.png') }}" alt="" width="38"></div>
                        <div class="rounded-1 border border-translucent me-2" data-variant="Red" data-products-images='["{{ asset('seller/assets/img/products/details/red_front.png') }}","{{ asset('seller/assets/img/products/details/red_back.png') }}","{{ asset('seller/assets/img/products/details/red_side.png') }}"]'><img src="{{ asset('seller/assets/img/products/details/red_front.png') }}" alt="" width="38"></div>
                        <div class="rounded-1 border border-translucent me-2" data-variant="Green" data-products-images='["{{ asset('seller/assets/img/products/details/green_front.png') }}","{{ asset('seller/assets/img/products/details/green_back.png') }}","{{ asset('seller/assets/img/products/details/green_side.png') }}"]'><img src="{{ asset('seller/assets/img/products/details/green_front.png') }}" alt="" width="38"></div>
                        <div class="rounded-1 border border-translucent me-2" data-variant="Purple" data-products-images='["{{ asset('seller/assets/img/products/details/purple_front.png') }}","{{ asset('seller/assets/img/products/details/purple_back.png') }}","{{ asset('seller/assets/img/products/details/purple_side.png') }}"]'><img src="{{ asset('seller/assets/img/products/details/purple_front.png') }}" alt="" width="38"></div>
                        <div class="rounded-1 border border-translucent me-2" data-variant="Silver" data-products-images='["{{ asset('seller/assets/img/products/details/silver_front.png') }}","{{ asset('seller/assets/img/products/details/silver_back.png') }}","{{ asset('seller/assets/img/products/details/silver_side.png') }}"]'><img src="{{ asset('seller/assets/img/products/details/silver_front.png') }}" alt="" width="38"></div>
                        <div class="rounded-1 border border-translucent me-2" data-variant="Yellow" data-products-images='["{{ asset('seller/assets/img/products/details/yellow_front.png') }}","{{ asset('seller/assets/img/products/details/yellow_back.png') }}","{{ asset('seller/assets/img/products/details/yellow_side.png') }}"]'><img src="{{ asset('seller/assets/img/products/details/yellow_front.png') }}" alt="" width="38"></div>
                        <div class="rounded-1 border border-translucent me-2" data-variant="Orange" data-products-images='["{{ asset('seller/assets/img/products/details/orange_front.png') }}","{{ asset('seller/assets/img/products/details/orange_back.png') }}","{{ asset('seller/assets/img/products/details/orange_side.png') }}"]'><img src="{{ asset('seller/assets/img/products/details/orange_front.png') }}" alt="" width="38"></div>
                      </div>
                    </div>
              ...
              <div class="col-12 col-lg-7 col-xl-8">
                <div class="tab-content" id="productTabContent">
                  <div class="tab-pane pe-lg-6 pe-xl-12 fade show active text-body-emphasis" id="tab-description" role="tabpanel" aria-labelledby="description-tab">
                    <p class="mb-5">{{ $product->description }}</p><a href="seller/assets/img/products/23.png" data-gallery="gallery-description"><img class="img-fluid mb-5 rounded-3" src="seller/assets/img/products/23.png" alt=""></a>
                    ...
                    <div class="bg-body-emphasis rounded-3 p-4 border border-translucent">
                              ...
                              <div class="modal-content p-4">
                                ...
                                <div class="dropzone dropzone-multiple p-0 mb-3" id="my-awesome-dropzone" data-dropzone="">
                                  ...
                                  <div class="dz-preview d-flex flex-wrap">
                                    <div class="border border-translucent bg-body-emphasis rounded-3 d-flex flex-center position-relative me-2 mb-2" style="height:80px;width:80px;"><img class="dz-image" src="seller/assets/img/products/23.png" alt="..." data-dz-thumbnail=""><a class="dz-remove text-body-quaternary" href="#!" data-dz-remove=""><span data-feather="x"></span></a></div>
                                  </div>
                                  <div class="dz-message text-body-tertiary text-opacity-85 fw-bold fs-9 p-4" data-dz-message=""> Drag your photo here <span class="text-body-secondary">or </span><button class="btn btn-link p-0">Browse from device </button><br><img class="mt-3 me-2" src="seller/assets/img/icons/image-icon.png" width="24" alt=""></div>
                                </div>
                      ...
                      <div class="mb-4 hover-actions-trigger btn-reveal-trigger">
                        ...
                        <div class="row g-2 mb-2">
                          <div class="col-auto"><a href="seller/assets/img/e-commerce/review-11.jpg" data-gallery="gallery-0"><img src="seller/assets/img/e-commerce/review-11.jpg" alt="" height="164"></a></div>
                          <div class="col-auto"><a href="seller/assets/img/e-commerce/review-12.jpg" data-gallery="gallery-0"><img src="seller/assets/img/e-commerce/review-12.jpg" alt="" height="164"></a></div>
                          <div class="col-auto"><a href="seller/assets/img/e-commerce/review-13.jpg" data-gallery="gallery-0"><img src="seller/assets/img/e-commerce/review-13.jpg" alt="" height="164"></a></div>
                        </div>
                      ...
                      <div class="mb-4 hover-actions-trigger btn-reveal-trigger">
                        ...
                        <div class="row g-2 mb-2">
                          <div class="col-auto"><a href="seller/assets/img/e-commerce/review-14.jpg" data-gallery="gallery-3"><img src="seller/assets/img/e-commerce/review-14.jpg" alt="" height="164"></a></div>
                          <div class="col-auto"><a href="seller/assets/img/e-commerce/review-15.jpg" data-gallery="gallery-3"><img src="seller/assets/img/e-commerce/review-15.jpg" alt="" height="164"></a></div>
                          <div class="col-auto"><a href="seller/assets/img/e-commerce/review-16.jpg" data-gallery="gallery-3"><img src="seller/assets/img/e-commerce/review-16.jpg" alt="" height="164"></a></div>
                        </div>
                        <div class="hover-actions top-0"><button class="btn btn-sm btn-phoenix-secondary me-2"><span class="fas fa-thumbs-up"></span></button><button class="btn btn-sm btn-phoenix-secondary me-1"><span class="fas fa-thumbs-down"></span></button></div>
                      </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="border-dashed border-y border-translucent py-4">
                      <div class="d-flex align-items-center mb-5">
                        <div class="form-check mb-0"><input class="form-check-input" type="checkbox" checked="checked"><label class="form-check-label"></label></div><a href="product-details.html"> <img class="border border-translucent rounded" src="seller/assets/img/products/2.png" width="53" alt=""></a>
                        <div class="ms-2"><a class="fs-9 fw-bold line-clamp-2 mb-2" href="product-details.html"> iPhone 13 pro max-Pacific Blue- 128GB</a>
                          <h5>$899.99</h5>
                        </div>
                      </div>
                      <div class="d-flex align-items-center mb-5">
                        <div class="form-check mb-0"><input class="form-check-input" type="checkbox" checked="checked"><label class="form-check-label"></label></div><a href="product-details.html"> <img class="border border-translucent rounded" src="seller/assets/img/products/16.png" width="53" alt=""></a>
                        <div class="ms-2"><a class="fs-9 fw-bold line-clamp-2 mb-2" href="product-details.html">Apple AirPods Pro</a>
                          <h5>$59.00</h5>
                        </div>
                      </div>
                      <div class="d-flex align-items-center mb-0">
                        <div class="form-check mb-0"><input class="form-check-input" type="checkbox"><label class="form-check-label"></label></div><a href="product-details.html"> <img class="border border-translucent rounded" src="seller/assets/img/products/10.png" width="53" alt=""></a>
                        <div class="ms-2"><a class="fs-9 fw-bold line-clamp-2 mb-2" href="product-details.html">Apple Magic Mouse (Wireless, Rechargable) - Silver, Worst mouse ever</a>
                          <h5>$89.00</h5>
                        </div>
                      </div>
                    </div>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="position-relative text-decoration-none product-card h-100">
                    <div class="d-flex flex-column justify-content-between h-100">
                      <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3"><button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img class="img-fluid" src="seller/assets/img/products/3.png" alt=""></div><a class="stretched-link" href="product-details.html">
                ...
                <div class="swiper-slide">
                  <div class="position-relative text-decoration-none product-card h-100">
                    <div class="d-flex flex-column justify-content-between h-100">
                      <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3"><button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img class="img-fluid" src="seller/assets/img/products/5.png" alt=""></div><a class="stretched-link" href="product-details.html">
                ...
                <div class="swiper-slide">
                  <div class="position-relative text-decoration-none product-card h-100">
                    <div class="d-flex flex-column justify-content-between h-100">
                      <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3"><button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img class="img-fluid" src="seller/assets/img/products/16.png" alt=""></div><a class="stretched-link" href="product-details.html">
                ...
                <div class="swiper-slide">
                  <div class="position-relative text-decoration-none product-card h-100">
                    <div class="d-flex flex-column justify-content-between h-100">
                      <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3"><button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img class="img-fluid" src="seller/assets/img/products/10.png" alt=""></div><a class="stretched-link" href="product-details.html">
                ...
                <div class="swiper-slide">
                  <div class="position-relative text-decoration-none product-card h-100">
                    <div class="d-flex flex-column justify-content-between h-100">
                      <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3"><button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img class="img-fluid" src="seller/assets/img/products/6.png" alt=""></div><a class="stretched-link" href="product-details.html">
            ...
            <div class="card-body chat p-0">
              <div class="d-flex flex-column-reverse scrollbar h-100 p-3">
                ...
                <div class="text-center mt-auto">
                  <div class="avatar avatar-3xl status-online"><img class="rounded-circle border border-3 border-light-subtle" src="seller/assets/img/team/30.webp" alt=""></div>
        ...
        <div class="container-small">
          <div class="row justify-content-between gy-4">
            <div class="col-12 col-lg-4">
              <div class="d-flex align-items-center mb-3"><img src="seller/assets/img/icons/logo.png" alt="phoenix" width="27">
                <h5 class="logo-text ms-2">phoenix</h5>
              </div>
              <p class="text-body-tertiary mb-1 fw-semibold lh-sm fs-9">Adminzone is an admin dashboard template with fascinating features and amazing layout. The template is responsive to all major browsers and is compatible with all available devices and screen sizes.</p>
            </div>
            <div class="col-6 col-md-auto">
              <h5 class="fw-bolder mb-3">About Adminzone</h5>
            ...
            <div class="col-6 col-md-auto">
              ...
              <div class="d-flex flex-column"><a class="text-body-tertiary fw-semibold fs-9 mb-1" href="#!">Help Desk</a><a class="text-body-tertiary fw-semibold fs-9 mb-1" href="#!">Support, 24/7</a><a class="text-body-tertiary fw-semibold fs-9 mb-1" href="#!">Community of Adminzone</a></div>
            </div>
            <div class="col-6 col-md-auto">
      ...
      <footer class="footer position-relative">
        <div class="row g-0 justify-content-between align-items-center h-100">
          <div class="col-12 col-sm-auto text-center">
            <p class="mb-0 mt-2 mt-sm-0 text-body">Thank you for creating with Adminzone<span class="d-none d-sm-inline-block"></span><span class="d-none d-sm-inline-block mx-1">|</span><br class="d-sm-none">2025 &copy;<a class="mx-1" href="https://keshdev.tech">Themewagon</a></p>
          </div>
          <div class="col-12 col-sm-auto text-center">
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
      ...
      <div class="offcanvas-body scrollbar px-card" id="themeController">
        <div class="setting-panel-item mt-0">
          ...
          <div class="row gx-2">
            <div class="col-4"><input class="btn-check" id="themeSwitcherLight" name="theme-color" type="radio" value="light" data-theme-control="phoenixTheme"><label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherLight"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="seller/assets/img/generic/default-light.png" alt=""></span><span class="label-text">Light</span></label></div>
            <div class="col-4"><input class="btn-check" id="themeSwitcherDark" name="theme-color" type="radio" value="dark" data-theme-control="phoenixTheme"><label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherDark"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="seller/assets/img/generic/default-dark.png" alt=""></span><span class="label-text"> Dark</span></label></div>
            <div class="col-4"><input class="btn-check" id="themeSwitcherAuto" name="theme-color" type="radio" value="auto" data-theme-control="phoenixTheme"><label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherAuto"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="seller/assets/img/generic/auto.png" alt=""></span><span class="label-text"> Auto</span></label></div>
          </div>
        </div>
        ...
        <div class="setting-panel-item">
          ...
          <div class="row gx-2">
            <div class="col-6"><input class="btn-check" id="navbarPositionVertical" name="navigation-type" type="radio" value="vertical" data-theme-control="phoenixNavbarPosition" disabled="disabled"><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionVertical"> <span class="rounded d-block"><img class="img-fluid img-prototype d-dark-none" src="seller/assets/img/generic/default-light.png" alt=""><img class="img-fluid img-prototype d-light-none" src="seller/assets/img/generic/default-dark.png" alt=""></span><span class="label-text">Vertical</span></label></div>
            <div class="col-6"><input class="btn-check" id="navbarPositionHorizontal" name="navigation-type" type="radio" value="horizontal" data-theme-control="phoenixNavbarPosition" disabled="disabled"><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionHorizontal"> <span class="rounded d-block"><img class="img-fluid img-prototype d-dark-none" src="seller/assets/img/generic/top-default.png" alt=""><img class="img-fluid img-prototype d-light-none" src="seller/assets/img/generic/top-default-dark.png" alt=""></span><span class="label-text"> Horizontal</span></label></div>
            <div class="col-6"><input class="btn-check" id="navbarPositionCombo" name="navigation-type" type="radio" value="combo" data-theme-control="phoenixNavbarPosition" disabled="disabled"><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionCombo"> <span class="rounded d-block"><img class="img-fluid img-prototype d-dark-none" src="seller/assets/img/generic/nav-combo-light.png" alt=""><img class="img-fluid img-prototype d-light-none" src="seller/assets/img/generic/nav-combo-dark.png" alt=""></span><span class="label-text"> Combo</span></label></div>
            <div class="col-6"><input class="btn-check" id="navbarPositionTopDouble" name="navigation-type" type="radio" value="dual-nav" data-theme-control="phoenixNavbarPosition" disabled="disabled"><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionTopDouble"> <span class="rounded d-block"><img class="img-fluid img-prototype d-dark-none" src="seller/assets/img/generic/dual-light.png" alt=""><img class="img-fluid img-prototype d-light-none" src="seller/assets/img/generic/dual-dark.png" alt=""></span><span class="label-text"> Dual nav</span></label></div>
          </div>
        ...
        <div class="setting-panel-item">
          ...
          <div class="row gx-2">
            <div class="col-6"><input class="btn-check" id="navbar-style-default" type="radio" name="config.name" value="default" data-theme-control="phoenixNavbarVerticalStyle" disabled="disabled"><label class="btn d-block w-100 btn-navbar-style fs-9" for="navbar-style-default"> <img class="img-fluid img-prototype d-dark-none" src="seller/assets/img/generic/default-light.png" alt=""><img class="img-fluid img-prototype d-light-none" src="seller/assets/img/generic/default-dark.png" alt=""><span class="label-text d-dark-none"> Default</span><span class="label-text d-light-none">Default</span></label></div>
            <div class="col-6"><input class="btn-check" id="navbar-style-dark" type="radio" name="config.name" value="darker" data-theme-control="phoenixNavbarVerticalStyle" disabled="disabled"><label class="btn d-block w-100 btn-navbar-style fs-9" for="navbar-style-dark"> <img class="img-fluid img-prototype d-dark-none" src="seller/assets/img/generic/vertical-darker.png" alt=""><img class="img-fluid img-prototype d-light-none" src="seller/assets/img/generic/vertical-lighter.png" alt=""><span class="label-text d-dark-none"> Darker</span><span class="label-text d-light-none">Lighter</span></label></div>
          </div>
        ...
        <div class="setting-panel-item">
          ...
          <div class="row gx-2">
            <div class="col-6"><input class="btn-check" id="navbarShapeDefault" name="navbar-shape" type="radio" value="default" data-theme-control="phoenixNavbarTopShape" disabled="disabled"><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarShapeDefault"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0" src="seller/assets/img/generic/top-default.png" alt=""><img class="img-fluid img-prototype d-light-none mb-0" src="seller/assets/img/generic/top-default-dark.png" alt=""></span><span class="label-text">Default</span></label></div>
            <div class="col-6"><input class="btn-check" id="navbarShapeSlim" name="navbar-shape" type="radio" value="slim" data-theme-control="phoenixNavbarTopShape" disabled="disabled"><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarShapeSlim"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0" src="seller/assets/img/generic/top-slim.png" alt=""><img class="img-fluid img-prototype d-light-none mb-0" src="seller/assets/img/generic/top-slim-dark.png" alt=""></span><span class="label-text"> Slim</span></label></div>
          </div>
        ...
        <div class="setting-panel-item">
          ...
          <div class="row gx-2">
            <div class="col-6"><input class="btn-check" id="navbarTopDefault" name="navbar-top-style" type="radio" value="default" data-theme-control="phoenixNavbarTopStyle" disabled="disabled"><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDefault"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0" src="seller/assets/img/generic/top-default.png" alt=""><img class="img-fluid img-prototype d-light-none mb-0" src="seller/assets/img/generic/top-style-darker.png" alt=""></span><span class="label-text">Default</span></label></div>
            <div class="col-6"><input class="btn-check" id="navbarTopDarker" name="navbar-top-style" type="radio" value="darker" data-theme-control="phoenixNavbarTopStyle" disabled="disabled"><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDarker"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0" src="seller/assets/img/generic/navbar-top-style-light.png" alt=""><img class="img-fluid img-prototype d-light-none mb-0" src="seller/assets/img/generic/top-style-lighter.png" alt=""></span><span class="label-text d-dark-none">Darker</span><span class="label-text d-light-none">Lighter</span></label></div>
          </div>
    ...
    <script src="{{ asset('seller/vendors/rater-js/index.js') }}"></script>
    <script src="{{ asset('seller/vendors/glightbox/glightbox.min.js') }}"> </script>
