...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('seller/assets/img/favicons/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('seller/assets/img/favicons/favicon-16x16.png') }}">
    ...
    <link href="../../../../../css2-1?family=Nunito+Sans:wght@300;400;600;700;800;900&amp;display=swap"
        rel="stylesheet">
    ...
    <link href="{{ asset('seller/assets/css/user-rtl.min.css') }}" type="text/css" rel="stylesheet"
        id="user-style-rtl">
    <link href="{{ asset('seller/assets/css/user.min.css') }}" type="text/css" rel="stylesheet"
    ...
    <main class="main" id="top">
        ...
        <nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault" style="display:none;">
            ...
            <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-travel-agency"
                    role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-travel-agency">
                    <div class="d-flex align-items-center">
                        <div class="dropdown-indicator-icon-wrapper"><span
                                class="fas fa-caret-right dropdown-indicator-icon"></span></div><span
                            ...
                            <div class="parent-wrapper">
                                <ul class="nav collapse parent" data-bs-parent="#travel-agency" id="nv-hotel">
                                    <li class="nav-item"><a class="nav-link dropdown-indicator"
                                            href="#nv-hotel-admin" data-bs-toggle="collapse" aria-expanded="false"
                                        ...
                                        <div class="parent-wrapper">
                                            <ul class="nav collapse parent" data-bs-parent="#hotel"
                                                id="nv-hotel-admin">
                                                <li class="nav-item"><a class="nav-link"
                                                        href="../../travel-agency/hotel/admin/add-property.html">
                                                        <div class="d-flex align-items-center"><span
                                                                class="nav-link-text">Add property</span></div>
                                                    </a><!-- more inner pages-->
                                                </li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="../../travel-agency/hotel/admin/add-room.html">
                                                        <div class="d-flex align-items-center"><span
                                                                class="nav-link-text">Add room</span></div>
                                                    </a><!-- more inner pages-->
                                                </li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="../../travel-agency/hotel/admin/room-listing.html">
                                                        <div class="d-flex align-items-center"><span
                                                                class="nav-link-text">Room listing</span></div>
                                                    </a><!-- more inner pages-->
                                                </li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="../../travel-agency/hotel/admin/room-search.html">
                                                        <div class="d-flex align-items-center"><span
                                                                class="nav-link-text">Search room</span></div>
                                                    </a><!-- more inner pages-->
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="nav-item"><a class="nav-link dropdown-indicator"
                                            href="#nv-hotel-customer" data-bs-toggle="collapse" aria-expanded="false"
                                        ...
                                        <div class="parent-wrapper">
                                            <ul class="nav collapse parent" data-bs-parent="#hotel"
                                                ...
                                                <li class="nav-item"><a class="nav-link"
                                                        href="../../travel-agency/hotel/customer/homepage.html">
                                                        <div class="d-flex align-items-center"><span
                                                                class="nav-link-text">Homepage</span></div>
                                                    </a><!-- more inner pages-->
                                                </li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="../../travel-agency/hotel/customer/hotel-details.html">
                                                        <div class="d-flex align-items-center"><span
                                                                class="nav-link-text">Hotel details</span></div>
                                                    </a><!-- more inner pages-->
                                                </li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="../../travel-agency/hotel/customer/hotel-compare.html">
                                                        <div class="d-flex align-items-center"><span
                                                                class="nav-link-text">Hotel compare</span></div>
                                                    </a><!-- more inner pages-->
                                                </li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="../../travel-agency/hotel/customer/checkout.html">
                                                        <div class="d-flex align-items-center"><span
                                                                class="nav-link-text">Checkout</span></div>
                                                    </a><!-- more inner pages-->
                                                </li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="../../travel-agency/hotel/customer/payment.html">
                                                        <div class="d-flex align-items-center"><span
                                                                class="nav-link-text">Payment</span></div>
                                                    </a><!-- more inner pages-->
                                                </li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="../../travel-agency/hotel/customer/gallery.html">
                                                        <div class="d-flex align-items-center"><span
                                                                class="nav-link-text">Gallery</span></div>
                                                    </a><!-- more inner pages-->
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-flight"
                            ...
                            <div class="parent-wrapper">
                                <ul class="nav collapse parent" data-bs-parent="#travel-agency" id="nv-flight">
                                    <li class="nav-item"><a class="nav-link"
                                            href="../../travel-agency/flight/homepage.html">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text">Homepage</span></div>
                                        </a><!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="../../travel-agency/flight/booking.html">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text">Booking</span></div>
                                        </a><!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="../../travel-agency/flight/payment.html">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text">Payment</span></div>
                                        </a><!-- more inner pages-->
                                    </li>
                        ...
                        <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-trip"
                            ...
                            <div class="parent-wrapper">
                                <ul class="nav collapse parent" data-bs-parent="#travel-agency" id="nv-trip">
                                    <li class="nav-item"><a class="nav-link"
                                            href="../../travel-agency/trip/homepage.html">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text">Homepage</span></div>
                                        </a><!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="../../travel-agency/trip/trip-details.html">
                                            <div class="d-flex align-items-center"><span class="nav-link-text">Trip
                                                    details</span></div>
                                        </a><!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="../../travel-agency/trip/checkout.html">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text">Checkout</span></div>
                                        </a><!-- more inner pages-->
                                    </li>
            ...
            <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-stock"
                    role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-stock">
                    <div class="d-flex align-items-center">
                        <div class="dropdown-indicator-icon-wrapper"><span
                                class="fas fa-caret-right dropdown-indicator-icon"></span></div><span
            ...
            <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-kanban"
                    role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-kanban">
                    <div class="d-flex align-items-center">
                        <div class="dropdown-indicator-icon-wrapper"><span
                                class="fas fa-caret-right dropdown-indicator-icon"></span></div><span
            ...
            <div class="nav-item-wrapper"><a class="nav-link label-1" href="../../gantt-chart.html" role="button"
                    data-bs-toggle="" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                class="fa-solid fa-chart-gantt "></span></span><span
                            class="nav-link-text-wrapper"><span class="nav-link-text">Gantt chart</span></span><span
                            class="badge ms-2 badge badge-phoenix badge-phoenix-warning nav-link-badge">new</span>
                    </div>
                </a></div><!-- parent pages-->
            ...
            <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-gallery"
                    role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-gallery">
                    <div class="d-flex align-items-center">
                        <div class="dropdown-indicator-icon-wrapper"><span
                                class="fas fa-caret-right dropdown-indicator-icon"></span></div><span
            ...
            <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-file-manager"
                    role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-file-manager">
                    <div class="d-flex align-items-center">
                        <div class="dropdown-indicator-icon-wrapper"><span
                                class="fas fa-caret-right dropdown-indicator-icon"></span></div><span
            ...
            <div class="nav-item-wrapper"><a class="nav-link label-1" href="../../calendar.html" role="button"
                    data-bs-toggle="" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
            ...
            <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-landing"
                        role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-landing">
                        <div class="d-flex align-items-center">
                            <div class="dropdown-indicator-icon-wrapper"><span
                                    class="fas fa-caret-right dropdown-indicator-icon"></span></div><span
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-layouts"
                        role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-layouts">
                        <div class="d-flex align-items-center">
                            <div class="dropdown-indicator-icon-wrapper"><span
                                    class="fas fa-caret-right dropdown-indicator-icon"></span></div><span
                    ...
                    <div class="parent-wrapper label-1">
                        <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-layouts">
                            ...
                            <li class="nav-item"><a class="nav-link" href="../../../demo/navbar-horizontal.html"
                                    target="_blank">
            ...
            <li class="nav-item">
                ...
                <hr class="navbar-vertical-line"><!-- parent pages-->
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-forms"
                        role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-forms">
                        <div class="d-flex align-items-center">
                            <div class="dropdown-indicator-icon-wrapper"><span
                                    class="fas fa-caret-right dropdown-indicator-icon"></span></div><span
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-icons"
                        role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-icons">
                        <div class="d-flex align-items-center">
                            <div class="dropdown-indicator-icon-wrapper"><span
                                    class="fas fa-caret-right dropdown-indicator-icon"></span></div><span
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-tables"
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-ECharts"
                        role="button" data-bs-toggle="collapse" aria-expanded="false"
                    ...
                    <div class="parent-wrapper label-1">
                        <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-ECharts">
                            ...
                            <li class="nav-item"><a class="nav-link"
                                    ...
                                    <div class="d-flex align-items-center"><span class="nav-link-text">Candlestick
                                            charts</span></div>
                                </a><!-- more inner pages-->
                            </li>
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-components"
                        role="button" data-bs-toggle="collapse" aria-expanded="false"
                    ...
                    <div class="parent-wrapper label-1">
                        <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                            ...
                            <li class="nav-item"><a class="nav-link"
                                    href="../../../modules/components/dhtmlx-gantt.html">
                                    <div class="d-flex align-items-center"><span class="nav-link-text">Dhtmlx
                                            gantt</span><span
                            ...
                            <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-navs-_and_-Tabs"
                            ...
                            <li class="nav-item"><a class="nav-link"
                                    ...
                                    <div class="d-flex align-items-center"><span class="nav-link-text">Typed
                                            text</span></div>
                                </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link"
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-utilities"
                        role="button" data-bs-toggle="collapse" aria-expanded="false"
                    ...
                    <div class="parent-wrapper label-1">
                        <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                            ...
                            <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-level-two"
                                    data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-level-two">
                                    <div class="d-flex align-items-center">
                                        <div class="dropdown-indicator-icon-wrapper"><span
                                                class="fas fa-caret-right dropdown-indicator-icon"></span></div><span
                            ...
                            <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-level-three"
                                    data-bs-toggle="collapse" aria-expanded="false"
                                ...
                                <div class="parent-wrapper">
                                    <ul class="nav collapse parent" data-bs-parent="#multi-level"
                                        ...
                                        <li class="nav-item"><a class="nav-link dropdown-indicator"
                                                href="#nv-item-4" data-bs-toggle="collapse" aria-expanded="false"
                            ...
                            <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-level-four"
                                    data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-level-four">
                                    <div class="d-flex align-items-center">
                                        <div class="dropdown-indicator-icon-wrapper"><span
                                                class="fas fa-caret-right dropdown-indicator-icon"></span></div><span
                                ...
                                <div class="parent-wrapper">
                                    <ul class="nav collapse parent" data-bs-parent="#multi-level"
                                        ...
                                        <li class="nav-item"><a class="nav-link dropdown-indicator"
                                                href="#nv-item-7" data-bs-toggle="collapse" aria-expanded="false"
                ...
                <a class="navbar-brand me-1 me-sm-3" href="../../../index.html">
                    <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center"><img
                                src="{{ asset('seller/assets/img/icons/logo.png') }}" alt="phoenix"
                                width="27">
                        ...
                        <div class="list pb-3">
                            ...
                            <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                                    ...
                                    <div class="file-thumbnail me-2"><img
                                            ...
                                            src="{{ asset('seller/assets/img/products/60x60/3.png') }}"
                                            alt=""></div>
                                    <div class="flex-1">
                            ...
                            <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                                    ...
                                    <div class="avatar avatar-l status-online  me-2 text-body">
                                        <img class="rounded-circle "
                                            src="{{ asset('seller/assets/img/team/40x40/10.webp') }}"
                                            alt="">
                                    </div>
                                    <div class="flex-1">
                                ...
                                <a class="dropdown-item py-2 d-flex align-items-center"
                                    ...
                                    <div class="avatar avatar-l  me-2 text-body">
                                        <img class="rounded-circle "
                                            src="{{ asset('seller/assets/img/team/40x40/12.webp') }}"
                                            alt="">
                                    </div>
                                    <div class="flex-1">
            ...
            <ul class="navbar-nav navbar-nav-icons flex-row">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar avatar-m status-online me-3"><img
                                                        ...
                                                        src="{{ asset('seller/assets/img/team/40x40/30.webp') }}"
                                                        alt=""></div>
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar avatar-m status-online me-3"><img
                                                        ...
                                                        src="{{ asset('seller/assets/img/team/40x40/avatar.webp') }}"
                                                        alt=""></div>
                                                <div class="flex-1 me-sm-3">
                                                    <h4 class="fs-9 text-body-emphasis">Jessie Samson</h4>
                                                    <p class="fs-9 text-body-highlight mb-2 mb-sm-3 fw-normal"><span
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar avatar-m status-online me-3"><img
                                                        class="rounded-circle"
                                                        src="{{ asset('seller/assets/img/team/40x40/57.webp') }}"
                                                        alt=""></div>
                                                <div class="flex-1 me-sm-3">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar avatar-m status-online me-3"><img
                                                        class="rounded-circle"
                                                        src="{{ asset('seller/assets/img/team/40x40/59.webp') }}"
                                                        alt=""></div>
                                                <div class="flex-1 me-sm-3">
                                    ...
                                    <div class="px-2 px-sm-3 py-3 notification-card position-relative read ">
                                        <div
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar avatar-m status-online me-3"><img
                                                        class="rounded-circle"
                                                        src="{{ asset('seller/assets/img/team/40x40/58.webp') }}"
                                                        alt=""></div>
                                                <div class="flex-1 me-sm-3">
                            ...
                            <div class="card-body pt-3 px-3 pb-0 overflow-auto scrollbar" style="height: 20rem;">
                                <div class="row text-center align-items-center gx-0 gy-0">
                                    <div class="col-4"><a
                                            ...
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/behance.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/google-cloud.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/slack.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/gitlab.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/bitbucket.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/google-drive.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/trello.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/figma.webp') }}"
                                                alt="" width="20">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/twitter.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/pinterest.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/ln.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/google-maps.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/google-photos.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('seller/assets/img/nav-icons/spotify.webp') }}"
                                                alt="" width="30">
                ...
                <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser"
                        ...
                        <div class="avatar avatar-l ">
                            <img class="rounded-circle " src="{{ asset('seller/assets/img/team/40x40/57.webp') }}"
                                alt="">
                        </div>
                    </a>
                            ...
                            <div class="card-body p-0">
                                <div class="text-center pt-4 pb-3">
                                    <div class="avatar avatar-xl ">
                                        <img class="rounded-circle "
                                            src="{{ asset('seller/assets/img/team/72x72/57.webp') }}"
                                            alt="Jerry Seinfield">
                                    </div>
                ...
                <ul class="navbar-nav navbar-nav-icons flex-row">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" id="navbarDropdownNotification" href="#" role="button"
                            ...
                            aria-expanded="false"><span class="d-inline-block"
        ...
        <nav class="navbar navbar-top fixed-top navbar-expand-lg" id="navbarTop" style="display:none;">
            <div class="d-flex align-items-center"><img src="{{ asset('seller/assets/img/icons/logo.png') }}"
            ...
            <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center"
                ...
                <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!"
                        ...
                        <ul class="dropdown-menu navbar-dropdown-caret">
                            ...
                            <li><a class="dropdown-item" href="../../../dashboard/stock.html">
                                    <div class="dropdown-item-wrapper"><span class="me-2 uil"
                                            data-feather="briefcase"></span>Stock</div>
                                </a></li>
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!"
                            role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                            aria-haspopup="true" aria-expanded="false"><span
                                class="uil fs-8 me-2 uil-cube"></span>Apps</a>
                        <ul class="dropdown-menu navbar-dropdown-caret">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="admin"
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item active" href="products">
                                                    <div class="dropdown-item-wrapper"><span
                            ...
                            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="travel-agency"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="trip"
                                            href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                            ...
                            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="stock"
                                    href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                                    <div class="dropdown-item-wrapper"><span
                                            class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                                class="me-2 uil" data-feather="dollar-sign"></span>Stock</span>
                                    </div>
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="../../stock/stock-details.html">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Stock
                                                details</div>
                                        </a></li>
                                    <li><a class="dropdown-item" href="../../stock/portfolio.html">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="me-2 uil"></span>Portfolio</div>
                                        </a></li>
                                    <li><a class="dropdown-item" href="../../stock/watchlist.html">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="me-2 uil"></span>Watchlist</div>
                                        </a></li>
                                </ul>
                            </li>
                            ...
                            <li><a class="dropdown-item" href="../../gantt-chart.html">
                                    <div class="dropdown-item-wrapper"><span
                                            class="me-2 fa-solid fa-chart-gantt "></span>Gantt chart</div>
                                </a></li>
                            ...
                            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="gallery"
                                    href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                                    <div class="dropdown-item-wrapper"><span
                                            class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                                class="me-2 uil" data-feather="image"></span>Gallery</span></div>
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="../../gallery/album.html">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Album
                                            </div>
                                        </a></li>
                                    <li><a class="dropdown-item" href="../../gallery/gallery-column.html">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Gallery
                                                column</div>
                                        </a></li>
                                    ...
                                    <li><a class="dropdown-item" href="../../gallery/grid-with-title.html">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Grid
                                                with title</div>
                                        </a></li>
                            ...
                            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="file-manager"
                                    href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                                    <div class="dropdown-item-wrapper"><span
                                            class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                                class="me-2 uil" data-feather="folder"></span>File manager</span>
                                    </div>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="../../file-manager/list-view.html">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>List
                                                view</div>
                                        </a></li>
                                </ul>
                            </li>
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!"
                            role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                            aria-haspopup="true" aria-expanded="false"><span
                                class="uil fs-8 me-2 uil-puzzle-piece"></span>Modules</a>
                                    ...
                                    <div class="row gx-4 gy-5">
                                        <div class="col-12 col-sm-6 col-md-4">
                                            <div class="dropdown-item-group"><span class="me-2"
                                                ...
                                                href="../../../modules/forms/advance/range.html">Range</a><a
                                                class="dropdown-link"
                                        ...
                                        <div class="col-12 col-sm-6 col-md-4">
                                            <div class="dropdown-item-group"><span class="me-2"
                                                ...
                                                class="dropdown-link"
                                                href="../../../modules/components/dhtmlx-gantt.html">Dhtmlx
                                                gantt</a><a class="dropdown-link"
                ...
                <div class="d-flex flex-between-center dual-nav-first-layer">
                    ...
                    <ul class="navbar-nav navbar-nav-icons flex-row">
                                ...
                                <div class="card position-relative border-0">
                                    ...
                                    <div class="card-footer p-0 border-top border-translucent border-0">
                                        <div
                                            ...
                                            <a class="fw-bolder"
                                                href="../../../pages/notifications.html">Notification history</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser"
                                ...
                                <div class="avatar avatar-l ">
                                    <img class="rounded-circle "
                                        src="{{ asset('seller/assets/img/team/40x40/57.webp') }}" alt="">
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border"
                                aria-labelledby="navbarDropdownUser">
                                    ...
                                    <div class="overflow-auto scrollbar" style="height: 10rem;">
                                        <ul class="nav d-flex flex-column mb-2 pb-1">
                                            ...
                                            <li class="nav-item"><a class="nav-link px-3 d-block"
                                                    href="#!"><span class="me-2 text-body align-bottom"
                                                        data-feather="pie-chart"></span>Dashboard</a></li>
                                            <li class="nav-item"><a class="nav-link px-3 d-block" href="#!">
                                                    <span class="me-2 text-body align-bottom"
                                                        data-feather="lock"></span>Posts &amp; Activity</a></li>
                            ...
                            <ul class="dropdown-menu navbar-dropdown-caret">
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="CRM"
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="../../crm/report-details.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Report details</div>
                                            </a></li>
                                        <li><a class="dropdown-item" href="../../crm/add-contact.html">
                                                <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Add
                                                    contact</div>
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="travel-agency"
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="../../travel-agency/landing.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Landing</div>
                                            </a></li>
                                        <li class="dropdown"><a class="dropdown-item dropdown-toggle"
                                                id="hotel" href="#" data-bs-toggle="dropdown"
                                                data-bs-auto-close="outside">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                                            class="me-2 uil"></span>Hotel</span></div>
                                        ...
                                        <li class="dropdown"><a class="dropdown-item dropdown-toggle"
                                                id="flight" href="#" data-bs-toggle="dropdown"
                                                data-bs-auto-close="outside">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                                            class="me-2 uil"></span>Flight</span></div>
                                        ...
                                        <li class="dropdown"><a class="dropdown-item dropdown-toggle"
                                                id="trip" href="#" data-bs-toggle="dropdown"
                                                data-bs-auto-close="outside">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                                            class="me-2 uil"></span>Trip</span></div>
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="stock"
                                        ...
                                        <div class="dropdown-item-wrapper"><span
                                                class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                                    class="me-2 uil"
                                                    data-feather="dollar-sign"></span>Stock</span></div>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="../../stock/stock-details.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Stock details</div>
                                            </a></li>
                                        <li><a class="dropdown-item" href="../../stock/portfolio.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Portfolio</div>
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="gallery"
                                        ...
                                        <div class="dropdown-item-wrapper"><span
                                                class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                                    class="me-2 uil" data-feather="image"></span>Gallery</span>
                                        </div>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="../../gallery/album.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Album</div>
                                            </a></li>
                                        <li><a class="dropdown-item" href="../../gallery/gallery-column.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Gallery column</div>
                                            </a></li>
                                        <li><a class="dropdown-item" href="../../gallery/gallery-grid.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Gallery grid</div>
                                            </a></li>
                                        <li><a class="dropdown-item" href="../../gallery/grid-with-title.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Grid with title</div>
                                            </a></li>
                                        <li><a class="dropdown-item" href="../../gallery/gallery-masonry.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Gallery masonry</div>
                                            </a></li>
                                        <li><a class="dropdown-item" href="../../gallery/gallery-slider.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Gallery slider</div>
                                            </a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="file-manager"
                                        ...
                                        <div class="dropdown-item-wrapper"><span
                                                class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                                    class="me-2 uil" data-feather="folder"></span>File
                                                manager</span></div>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="../../file-manager/grid-view.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Grid view</div>
                                            </a></li>
                                        <li><a class="dropdown-item" href="../../file-manager/list-view.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>List view</div>
                                            </a></li>
                                    </ul>
                                </li>
                                <li><a class="dropdown-item" href="../../calendar.html">
                            ...
                            <ul class="dropdown-menu navbar-dropdown-caret">
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="faq"
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="../../../pages/faq/faq-accordion.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Faq accordion</div>
                                            </a></li>
                                        <li><a class="dropdown-item" href="../../../pages/faq/faq-tab.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Faq tab</div>
                                            </a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="landing"
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="pricing"
                                        ...
                                        <div class="dropdown-item-wrapper"><span
                                                class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                                    class="me-2 uil" data-feather="tag"></span>Pricing</span>
                                        </div>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item"
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="errors"
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="../../../pages/errors/404.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>404</div>
                                            </a></li>
                                        <li><a class="dropdown-item" href="../../../pages/errors/403.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>403</div>
                                            </a></li>
                                        <li><a class="dropdown-item" href="../../../pages/errors/500.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>500</div>
                                            </a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle"
                                        id="authentication" href="#" data-bs-toggle="dropdown"
                                        data-bs-auto-close="outside">
                                        <div class="dropdown-item-wrapper"><span
                                                class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                                    class="me-2 uil"
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="layouts"
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="../../../demo/navbar-horizontal.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Navbar horizontal</div>
                                            </a></li>
                                        <li><a class="dropdown-item" href="../../../demo/horizontal-slim.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Horizontal slim</div>
                                        ...
                                        <div class="row gx-4 gy-5">
                                            <div class="col-12 col-sm-6 col-md-4">
                                                ...
                                                <div class="dropdown-item-group mt-5"><span class="me-2"
                                                    ...
                                                    href="../../../modules/echarts/line-charts.html">Line
                                                    charts</a><a class="dropdown-link"
                                                    href="../../../modules/echarts/bar-charts.html">Bar charts</a><a
                                                    class="dropdown-link"
                                                    href="../../../modules/echarts/candlestick-charts.html">Candlestick
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <div class="dropdown-item-group"><span class="me-2"
                                                    ...
                                                    href="../../../modules/components/chat-widget.html">Chat
                                                    widget</a>
                                            </div>
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <div class="dropdown-item-group"><span class="me-2"
                    ...
                    <div class="mb-4">
                        <div class="d-flex flex-wrap gap-3">
                            ...
                            <div class="scrollbar overflow-hidden-y">
                                <div class="btn-group position-static" role="group">
                                    <div class="btn-group position-static text-nowrap"><button
                                            ...
                                            aria-haspopup="true" aria-expanded="false"
                                            data-bs-reference="parent"> Category<span
                                    ...
                                    <div class="btn-group position-static text-nowrap"><button
                                            ...
                                            aria-haspopup="true" aria-expanded="false"
                                            data-bs-reference="parent"> Vendor<span
                                                class="fas fa-angle-down ms-2"></span></button>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="#">Action</a></li>
                                            <li><a class="dropdown-item" href="#">Another action</a></li>
                            ...
                            <div class="ms-xxl-auto"><button class="btn btn-link text-body me-4 px-0"><span
                                    ...
                                    href="products/create" class="btn btn-primary" id="addBtn">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sort align-middle ps-4" scope="col" data-sort="category"
                                            style="width:150px;">SKU</th>
                                        <th class="sort align-middle ps-3" scope="col" data-sort="tags"
                                            style="width:250px;">Availablity</th>
                                ...
                                <tbody class="list" id="products-table-body">
                                    @foreach ($products as $product)
                                        <tr class="position-static">
                                            ...
                                            <td class="fs-9 align-middle">
                                                <div class="form-check mb-0 fs-8">
                                                    <input class="form-check-input" type="checkbox"
                                                        data-bulk-select-row='{{ json_encode(
                                                            [
                                                                'product' => $product->name,
                                                                'productImage' => $product->thumbnail
                                                                    ? asset('storage/' . $product->thumbnail)
                                                                    : asset('seller/assets/img/products/default.png'),
                                                                'price' => '₹' . number_format($product->price, 2),
                                                                'category' => $product->category->name ?? 'N/A',
                                                                'tags' => $product->tags?->pluck('name')->toArray() ?? [],
                                                                'star' => (bool) $product->is_featured,
                                                                'vendor' => $product->vendor->store_name ?? 'N/A',
                                                                'publishedOn' => $product->created_at->format('M d, h:i A'),
                                                            ],
                                            ...
                                            {{-- Price --}}
                                            <td class="price align-middle text-end fw-bold text-body-tertiary ps-4">
                                                ₹{{ number_format($product->price, 2) }}
                                            </td>

                                            {{-- Category --}}
                                            <td class="category align-middle fs-9 ps-4 fw-semibold">
                                                {{ $product->sku ?? '-' }}
                                            </td>
                                            ...
                                            <td class="tags align-middle review pb-2 ps-3"
                                                ...
                                                @if ($product->is_active == 1)
                                                    <span class="badge bg-success text-white fs-8">Active</span>
                                                @else
                                                    <span class="badge bg-danger text-white fs-8">Inactive</span>
                                                @endif
                                            </td>


                                            {{-- Featured
    <td class="align-middle fs-8 text-center ps-4">
        ...
        @endif
                                            ...
                                            {{-- Vendor
    <td class="vendor align-middle fw-semibold ps-4">
        {{ $product->vendor->store_name ?? '-' }}
    </td> --}}

                                            {{-- Time --}}
                                            <td class="time align-middle text-body-tertiary ps-4">
                                                {{ $product->created_at->format('M d, h:i A') }}
                                            </td>

                                            {{-- Actions --}}
                                            <td class="align-middle text-end pe-0 ps-4 btn-reveal-trigger">
                                                <div class="btn-reveal-trigger position-static">
                                                    <button class="btn btn-sm btn-reveal fs-10"
                                                        data-bs-toggle="dropdown">
                                                        <span class="fas fa-ellipsis-h"></span>
                                                    </button>
                                                    <div class="dropdown-menu dropdown-menu-end py-2">
                                                        <a class="dropdown-item"
                                                            href="{{ route('seller.products.show', $product->id) }}">View</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('seller.products.edit', $product->id) }}">Edit</a>
                        ...
                        <div class="btn-reveal-trigger"><button
                            ...
                            <div class="dropdown-menu dropdown-menu-end py-2"
                                aria-labelledby="support-chat-dropdown"><a class="dropdown-item"
                                    ...
                                    href="#!">Search in chat</a><a class="dropdown-item"
                                    href="#!">Show history</a><a class="dropdown-item"
                        ...
                        <div class="d-flex flex-column-reverse scrollbar h-100 p-3">
                            ...
                            <div class="text-center mt-auto">
                                <div class="avatar avatar-3xl status-online"><img
                                        ...
                                        src="{{ asset('seller/assets/img/team/30.webp') }}" alt="">
                                </div>
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1"
        ...
        <div class="offcanvas-body scrollbar px-card" id="themeController">
                ...
                <div class="row gx-2">
                    <div class="col-4"><input class="btn-check" id="themeSwitcherLight" name="theme-color"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherLight"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="{{ asset('seller/assets/img/generic/default-light.png ') }}"
                    ...
                    <div class="col-4"><input class="btn-check" id="themeSwitcherDark" name="theme-color"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherDark"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="{{ asset('seller/assets/img/generic/default-dark.png ') }}"
                    ...
                    <div class="col-4"><input class="btn-check" id="themeSwitcherAuto" name="theme-color"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherAuto"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="{{ asset('seller/assets/img/generic/auto.png ') }}"
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarPositionHorizontal"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionHorizontal"> <span
                                class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('seller/assets/img/generic/top-default.png ') }}"
                                    alt=""><img class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('seller/assets/img/generic/top-default-dark.png') }}"
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarPositionCombo"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionCombo"> <span
                                class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('seller/assets/img/generic/nav-combo-light.png ') }}"
                                    alt=""><img class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('seller/assets/img/generic/nav-combo-dark.png') }}"
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarPositionTopDouble"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionTopDouble"> <span
                                class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('seller/assets/img/generic/dual-light.png ') }}"
                                    alt=""><img class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('seller/assets/img/generic/dual-dark.png') }}"
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6"><input class="btn-check" id="navbar-style-dark" type="radio"
                            ...
                            class="btn d-block w-100 btn-navbar-style fs-9" for="navbar-style-dark"> <img
                                class="img-fluid img-prototype d-dark-none"
                                src="{{ asset('seller/assets/img/generic/vertical-darker.png ') }}"
                                alt=""><img class="img-fluid img-prototype d-light-none"
                                src="{{ asset('seller/assets/img/generic/vertical-lighter.png') }}"
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6"><input class="btn-check" id="navbarShapeSlim" name="navbar-shape"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="navbarShapeSlim"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{ asset('seller/assets/img/generic/top-slim.png ') }}"
                                    alt=""><img class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{ asset('seller/assets/img/generic/top-slim-dark.png') }}"
            ...
            <div class="setting-panel-item">
                ...
                <div class="row gx-2">
                    <div class="col-6"><input class="btn-check" id="navbarTopDefault"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDefault"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{ asset('seller/assets/img/generic/top-default.png ') }}"
                                    alt=""><img class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{ asset('seller/assets/img/generic/top-style-darker.png') }}"
                                    alt=""></span><span class="label-text">Default</span></label></div>
                    <div class="col-6"><input class="btn-check" id="navbarTopDarker"
                            name="navbar-top-style" type="radio" value="darker"
                            data-theme-control="phoenixNavbarTopStyle"><label
                            class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDarker"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{ asset('seller/assets/img/generic/navbar-top-style-light.png ') }}"
                                    alt=""><img class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{ asset('seller/assets/img/generic/top-style-lighter.png') }}"
