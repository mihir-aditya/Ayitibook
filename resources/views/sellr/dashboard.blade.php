...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <head>
    ...
    <link href="{{ asset('seller/vendors/leaflet/leaflet.css') }}" rel="stylesheet">
    <link href="{{ asset('seller/vendors/leaflet.markercluster/MarkerCluster.css') }}" rel="stylesheet">
    <link href="{{ asset('seller/vendors/leaflet.markercluster/MarkerCluster.Default.css') }}" rel="stylesheet">
  </head>
      ...
      <nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault" style="display:none;">
        <div class="collapse navbar-collapse justify-content-between">
          <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="index.html">Adminzone</a>
          </div>
        </div>
      </nav>
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-admin">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent show" data-bs-parent="#e-commerce" id="nv-admin">
                            <li class="nav-item"><a class="nav-link" href="/seller/products/create">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Add product</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="/seller/products">
        ...
        <div class="collapse navbar-collapse justify-content-between">
              <div class="d-flex align-items-center">
                <div class="d-flex align-items-center"><img src="assets/img/icons/logo.png" alt="phoenix" width="27">
                  <h5 class="logo-text ms-2 d-none d-sm-block">Adminzone</h5>
                </div>
              </div>
            </a>
          </div>
          ...
          <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-chart-pie"></span>Home</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li><a class="dropdown-item" href="dashboard/stock.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil" data-feather="briefcase"></span>Stock</div>
                  </a></li>
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-cube"></span>Apps</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="e-commerce" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="admin" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="/seller/products/create">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Add product</div>
                          </a></li>
                        <li><a class="dropdown-item" href="/seller/products">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="stock" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="apps/stock/stock-details.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Stock details</div>
                      </a></li>
                    <li><a class="dropdown-item" href="apps/stock/portfolio.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Portfolio</div>
                      </a></li>
                    <li><a class="dropdown-item" href="apps/stock/watchlist.html">
                ...
                <li><a class="dropdown-item" href="apps/gantt-chart.html">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="gallery" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="apps/gallery/album.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Album</div>
                      </a></li>
                    <li><a class="dropdown-item" href="apps/gallery/gallery-column.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Gallery column</div>
                      </a></li>
                    <li><a class="dropdown-item" href="apps/gallery/gallery-grid.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Gallery grid</div>
                      </a></li>
                    <li><a class="dropdown-item" href="apps/gallery/grid-with-title.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Grid with title</div>
                      </a></li>
                    <li><a class="dropdown-item" href="apps/gallery/gallery-masonry.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Gallery masonry</div>
                      </a></li>
                    <li><a class="dropdown-item" href="apps/gallery/gallery-slider.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Gallery slider</div>
                      </a></li>
                  </ul>
                </li>
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="file-manager" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="apps/file-manager/grid-view.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Grid view</div>
                      </a></li>
                    <li><a class="dropdown-item" href="apps/file-manager/list-view.html">
        ...
        <footer class="footer position-absolute">
          <div class="row g-0 justify-content-between align-items-center h-100">
            <div class="col-12 col-sm-auto text-center">
              <p class="mb-0 mt-2 mt-sm-0 text-body">Thank you for creating with Adminzone<span class="d-none d-sm-inline-block"></span><span class="d-none d-sm-inline-block mx-1">|</span><br class="d-sm-none">2025 &copy;<a class="mx-1" href="https://keshdev.tech">Keshdev.tech</a></p>
            </div>
            <div class="col-12 col-sm-auto text-center">
