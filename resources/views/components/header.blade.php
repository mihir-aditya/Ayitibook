<header class="">
    <div class="d-flex align-items-center justify-content-between header-large">
        <div class="website-logo">
            <img src="{{ asset('assets/images/logo/logo.svg') }}" alt="AyitiBook Logo">
        </div>
        <nav>
        ...
        <div class="header-item item-right hide-element">
            ...
            <a href="/wishlist" class="icon-tag position-relative">
                <img src="{{ asset('assets/images/Wishlist.png') }}" alt="Wishlist-img" class="">
            ...
            <a href="{{ route('cart.index') }}" class="icon-tag  position-relative">
                <img src="{{ asset('assets/images/buy-icon.png') }}" alt="buy-icon">
            ...
            <a href="{{ route('cart.index') }}" class="icon-tag wallet-bx position-relative">
                <img src="{{ asset('assets/images/wallet.png') }}" alt="buy-icon" style="width:25px;">
                    ...
                    <div class="">
                        <ul class="list-unstyled">
                            <li class="dropdown-submenu dropright-lg">
                                <a class="dropdown-item dropdown-list-group-item" href="/profile">
