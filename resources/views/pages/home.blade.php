...
<style>
    ...
    .custom-price .cents {
        ...
        top: 0;
        right: -20px;
        /* Adjust this value based on spacing */
        line-height: 1;
    }

    .meta-div {
        gap: 20px;
        /* Space between price and strike price */
    }



    /* 🌈 Animated Payment & Delivery Bar */
    .announcement-bar {
        margin-top: 5px;
        padding: 1px 0;
    }
    ...
    .announcement-wrap {
        ...
        align-items: center;
        gap: 12px;
        background: linear-gradient(90deg, #7b2ff7 0%, #ff6a00 50%, #22c1c3 100%);
        border-radius: 40px;
        padding: 12px 18px;
        color: #fff;
    ...
    .announcement-wrap::after {
        ...
        position: absolute;
        inset: -50%;
        background: linear-gradient(90deg, #6a11cb 0%, #a02cf6 20%, #ff6a00 45%, #ffd100 60%, #22c1c3 80%);
    ...
    .announcement-bar:hover .announcement-wrap::after,
    .announcement-wrap.paused::after {
  ...
  @include('includes.header')
    <div class="page-wrapper">
        <main class="main-wrapper">
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="banner-content">
                                                ...
                                                <div class="right-content">
                                                    <div class="image-div">
                                                        <img src="assets/images/banner/bnr-right-img.png"
                                                            alt="bnr-right-img">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="banner-content">
                                                <div class="left-content">
                                                    <div class="brand-title">
                                                        <img src="assets/images/banner/brand/apple.svg"
                                                            alt="">
                                                        <span class="fw-normal lh-1">iPhone 14 Series</span>
                                                    </div>
                                                    <h1 class="title">Up to 10% off Voucher</h1>
            ...
            <!-- 🌈 Payment, Delivery & Support Announcement Bar (below hero slider) -->
            <section class="announcement-bar my-3" role="region" aria-label="Payment and delivery information">
                <div class="announcement-wrap container">
                    <div class="announce-slide" tabindex="0">

                        <!-- 1️⃣ Payment Security -->
                        <div class="announce-item">
                            <i class="bx bx-wallet-alt"></i>
                            <div class="announce-text">
                                <h6>PAYMENT SECURITY</h6>
                                <p>Funds are held securely in your AyitiBook wallet until delivery and verification.</p>
                            </div>
                        </div>

                        <div class="announce-sep"></div>

                        <!-- 2️⃣ Guaranteed Delivery -->
                        <div class="announce-item">
                            <img src="./assets/images/footer/icon-delivery.png" alt="icon-delivery"
                                class="announce-icon">
                            <div class="announce-text">
                                <h6>GUARANTEED DELIVERY</h6>
                                <p>We ensure predictable, safe, and on-time delivery, supported by certified agents and
                        ...
                        <div class="announce-item">
                            ...
                            <div class="announce-text">
                                ...
                                <p>Enjoy your purchase for up to 30 days. Returns are simple — if you’re not happy, your
                                    money comes right back.</p>
                            </div>
                        </div>

                        <div class="announce-sep"></div>

                        <!-- 4️⃣ 24/7 Customer Service -->
                        <div class="announce-item">
                            <i class="bx bx-headphone"></i>
                            <div class="announce-text">
                                <h6>24/7 CUSTOMER SERVICE</h6>
                                <p>From quick chatbot responses to dedicated human care, we’re here 24/7 to keep your
                                    experience smooth, simple, and worry-free.</p>
                            </div>
                        </div>
            ...
            <section class="deal-section">
                <div class="container">
                                        ...
                                        <div class="media-box ">
                                            <div class="product-img">
                                                ...
                                                <div class="hover-btn">
                                                    ...
                                                    @endif
                                                    <a href="javascript:void(0);"
                                                        onclick="buyNow({{ $item->id }})" class="btn buy-now"> Buy
                                                        Now</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="product-icon-div">
                                                <ul class="ps-0">
                                                    <li class="like-icon">
                                                        <a href="javascript:void(0);" id="like-{{ $item->id }}"
                                                            class="{{ $item->is_wishlist ? 'active-like-icon' : '' }}"
                                        ...
                                        <div class="content-box">
                                            ...
                                            <div class="meta-div">
                                                <span class="price text-danger">
                                                    <span
                                                        class="currency">{{ $item->currency }}</span>{{ $item->price }}<sup>49</sup>
                                                </span>
                                                <p class="text1 text-muted  ">
                                                    <strike>{{ $item->currency }}160</strike>
                                                </p>
                    ...
                    <div class="text-center btn-gap">
                        <a href="{{ route('search-product') }}" class="btn btn-secondary rounded">View all
                            Product</a>
                    </div>
                    <hr>
                </div>
                                    ...
                                    <div class="icon-div">
                                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_1270_353)">
                                                ...
                                                <path d="M25.667 7H31.1357" stroke="black" stroke-width="3"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M28 44.0052V44.0305" stroke="black" stroke-width="2.5"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <line x1="15.167" y1="39.8333" x2="40.8337" y2="39.8333"
                                        ...
                                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_139_1085)">
                                                <path
                                                    ...
                                                    stroke="black" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M16.3333 46.6667H39.6667" stroke="black" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M21 37.3333V46.6666" stroke="black" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M35 37.3333V46.6666" stroke="black" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M8 32H48" stroke="black" stroke-width="2"
                                        ...
                                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_139_1524)">
                                                <path
                                                    ...
                                                    stroke="black" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M21 42V49H35V42" stroke="black" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M21 14V7H35V14" stroke="black" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                        ...
                                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_139_1373)">
                                                <path
                                                    ...
                                                    stroke="black" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M14 27.9999H23.3333M18.6667 23.3333V32.6666" stroke="black"
                                        ...
                                        <div class="media-box">
                                            <div class="product-img">
                                                ...
                                                <div class="hover-btn">
                                                    ...
                                                    @endif
                                                    <a href="javascript:void(0);"
                                                        onclick="buyNow({{ $item->id }})" class="btn buy-now">
                                                        Buy Now</a>
                                                </div>
                                            </div>
                                            <span class="badge style1 badge-primary">
                                ...
                                <div class="swiper-slide">
                                    <div class="latest-sale-box mb-4">
                                        <div class="media-box">
                                            <div class="product-img">
                                                ...
                                                <div class="hover-btn">
                                                    ...
                                                    @endif
                                                    <a href="javascript:void(0);"
                                                        onclick="buyNow({{ $product->id }})" class="btn buy-now">
                                                        Buy Now</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="product-icon-div">
                                                <ul class="ps-0">
                                                    <li class="like-icon">
                                                        <a href="javascript:void(0);" id="like-{{ $product->id }}"
                                                            class="{{ $product->is_wishlist ? 'active-like-icon' : '' }}"
                                        ...
                                        <div class="content-box">
                                            ...
                                            <div class="meta-div">
                                                <span
                                                    class="text1 text-danger">{{ $product->currency }}{{ $product->price }}</span>
                                            </div>
                                            <div class="bottom-box d-flex align-items-center">
                                                <div class="d-flex align-items-center rating-icon">
                                                    <i class="fas fa-star"></i>
                            ...
                            <div class="feature-image-box">
                                <div class="feature-img">
                                    <div class="content-area">
                                        ...
                                        <h4 class="feature-des">Black and White version of the PS5 <br> coming out on
                                            sale.</h4>
                                    ...
                                    <div class="feature-image-box style2">
                                        <div class="feature-img">
                                            <div class="content-area">
                                                ...
                                                <h4 class="feature-des">Featured woman collections that <br> give you
                                                    another vibe.</h4>
                                                <a href="#" class="btn-link">Shop Now</a>
                                            </div>
                                        </div>
                            ...
                            <div class="row justify-conent-center">
                                    ...
                                    <div class="services-icon-div text-center">
                                        <div class="icon-media">
                                            <div class="box-bg">
                                                ...
                                                <img src="./assets/images/footer/icon-delivery.png"
                                                    alt="icon-delivery">
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <div class="services-icon-div text-center">
                                        <div class="icon-media">
                                            <div class="box-bg">
                                                <img src="./assets/images/footer/Icon-Customer service.png"
                                                    alt="icon-delivery">
                                            </div>
                                        </div>
    ...
    <script>
        ...
        targetDate.setDate(targetDate.getDate() + 4); // Add 4 days
        targetDate.setHours(targetDate.getHours() + 12); // Add 12 hours
        targetDate.setMinutes(targetDate.getMinutes() + 30); // Add 30 minutes
        targetDate.setSeconds(targetDate.getSeconds() + 30); // Add 30 seconds
    ...
    <script>
        (function() {
            const wrap = document.querySelector('.announcement-wrap');
            const slide = document.querySelector('.announce-slide');
            if (!wrap) return;
            wrap.addEventListener('mouseenter', () => wrap.classList.add('paused'));
            wrap.addEventListener('mouseleave', () => wrap.classList.remove('paused'));
            slide.addEventListener('focus', () => wrap.classList.add('paused'));
            slide.addEventListener('blur', () => wrap.classList.remove('paused'));
        })();
    </script>
