    ...
    <header class="">
        <div class="d-flex align-items-center justify-content-between header-large">
            ...
            <nav>
                ...
                <ul class="menu">
                    <li class="nav-menu">
                        <a href="{{ route('affiliate.dashboard', auth()->user()->affiliate->id) }}">
                            Affiliate
                        </a>
                    </li>
                    <li class="nav-menu"><a href="index.html">me</a></li>
                            ...
                            <div class="swiper-slide">
                                <div class="latest-sale-box mb-4">
                                    <div class="media-box">
                                        <div class="product-img">
                                            <a href="product-detail.html">
                                                <img src="./assets/images/poducts/new-product1.png"
                                                    alt="new-product1">
                                            </a>
                                            <div class="hover-btn">
                                                <a href="cart-page.html" class="btn add-cart"> Add To Cart</a>
                            ...
                            <div class="swiper-slide">
                                <div class="latest-sale-box mb-4">
                                    <div class="media-box">
                                        <div class="product-img">
                                            <a href="product-detail.html">
                                                <img src="./assets/images/poducts/new-product2.png"
                                                    alt="new-product2">
                                            </a>
                                            <div class="hover-btn">
                                                <a href="cart-page.html" class="btn add-cart"> Add To Cart</a>
                                ...
                                <div class="latest-sale-box mb-4">
                                    <div class="media-box">
                                        <div class="product-img">
                                            ...
                                            <a href="product-detail.html">
                                                <img src="./assets/images/poducts/new-product3.png"
                                                    alt="new-product3">
                                            </a>
                                            <div class="hover-btn">
                                                <a href="cart-page.html" class="btn add-cart"> Add To Cart</a>
                                ...
                                <div class="latest-sale-box mb-4">
                                    <div class="media-box">
                                        <div class="product-img">
                                            ...
                                            <a href="product-detail.html">
                                                <img src="./assets/images/poducts/new-product4.png"
                                                    alt="new-product4">
                                            </a>
                                            <div class="hover-btn">
                                                <a href="cart-page.html" class="btn add-cart"> Add To Cart</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="right-image-area bnr-add-div">
                                    <img src="./assets/images/banner/add-banner.png"
                                        alt="banner-addvertisment image">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row justify-conent-center">
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <div class="services-icon-div text-center">
                                        <div class="icon-media">
                                            <div class="box-bg">
                                                <img src="./assets/images/footer/Icon-secure.png"
                                                    alt="icon-delivery">
                                            </div>
                                        </div>
            ...
            <div class="row text-white upper-text-box">
                ...
                <div class="col-md-2 mb-4 mb-md-0">
                    <div class="footer-link accounts">
                        ...
                        <ul class="list-unstyled footer-list">
                            ...
                            <li class="list-item"><a href="Login_Register.html" class="links">Login /
                                    Register</a></li>
                ...
                <div class="col-md-2 mb-4 mb-md-0">
                    <div class="footer-link quick-links">
                        ...
                        <ul class="list-unstyled footer-list">
                            <li class="list-item"><a href="privacy-policy.html" class="links">Privacy Policy</a>
                            </li>
                            <li class="list-item"><a href="terms-condition.html" class="links">Terms Of Use</a>
                            </li>
                    ...
                    <div class="footer-link download-app">
                        ...
                        <div class=" mt-3">
                            <div class="footer-link subscribe">
                                ...
                                <div
                                    class="input-group footer-email-input d-flex align-items-center justify-content-between">
