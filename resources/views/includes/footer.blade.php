...
<html lang="en">
    <head>
      ...
      <!-- Favicon Tags -->
      <link rel="icon" type="image/png" href="/dir/Ayitibook-project/17-april-2025/17-april-2025/assets/images/favicon.png">
      <link rel="apple-touch-icon" sizes="180x180" href="/dir/Ayitibook-project/17-april-2025/17-april-2025/assets/images/apple-touch-icon.png">
    
      <!-- CSS Stylesheet Link -->
      <link rel="stylesheet" type="text/css" href="/dir/Ayitibook-project/17-april-2025/17-april-2025/assets/vendor/fontawesome/css/all.min.css">
      <link rel="stylesheet" type="text/css" href="/dir/Ayitibook-project/17-april-2025/17-april-2025/assets/vendor/swiper/swiper-bundle.min.css">
      
      <!-- common css -->
      <link rel="stylesheet" type="text/css" href="/dir/Ayitibook-project/17-april-2025/17-april-2025/assets/css/style.css">
      <link rel="stylesheet" type="text/css" href="/dir/Ayitibook-project/17-april-2025/17-april-2025/assets/css/custom.css">
      <link rel="stylesheet" type="text/css" href="/dir/Ayitibook-project/17-april-2025/17-april-2025/assets/css/footer.css">
      <link rel="stylesheet" href="/dir/Ayitibook-project/17-april-2025/17-april-2025/assets/css/header.css">
...
<body>
    ...
    <!-- Footer Section -->
    <footer class="footer footer-bg" style="background: url('/dir/Ayitibook-project/17-april-2025/17-april-2025/assets/images/footer/footer-bg.jpg');">
          ...
          <div class="col-md-3 mb-4 mb-md-0">
            <div class="footer-link subscribe">
              ...
              <div class="website-logo">
                <a href="index.html"><img src="/dir/Ayitibook-project/17-april-2025/17-april-2025/assets/images/logo/logo.svg" alt="AyitiBook Logo"></a>
              </div>
               <!-- Clipart below the logo --> 
              <div class="footer-clipart text-center mt-3">
                  <img src="/dir/Ayitibook-project/17-april-2025/17-april-2025/assets/images/footer/footer_clipart.png" alt="Footer Clipart" style="max-width: auto; height: auto; display: block;">
              </div>
            </div>
          </div>
          <!-- Support Section -->
                ...
                <div class="input-group footer-email-input d-flex align-items-center justify-content-between">
                  ...
                  <div class="arrow-btn">
                    <a href="#" class="send-arrow-img">
                      <img src="/dir/Ayitibook-project/17-april-2025/17-april-2025/assets/images/footer/icon-send.png" alt="sent-arrow">
                    </a>
                </div>
            </div>
          </div>
          ...
          <div class="container py-0">
            <div class="row">
              <div class="col text-center">
                <p class="mb-0 copyright">&copy; Copyright Rimel 2022. All rights reserved</p>
              </div>
            </div>
          </div>
        </div>
